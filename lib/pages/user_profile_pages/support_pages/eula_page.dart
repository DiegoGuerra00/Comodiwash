...
class _EulaPageState extends State<EulaPage> {
  ...
  Widget buildPrivacyPolicyBody() {
    return Padding(
      padding: const EdgeInsets.all(14),
      child: buildPolicyText(),
    );
  }

  _downloadPolicy() async {
    const url =
        'https://docs.google.com/uc?export=download&id=1H5vlKjIM3gn96LGTs4P1_jStjOWv1QbO';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: GenericAppBar(title: 'Política de Privacidade', useTitle: true),
      body: buildPrivacyPolicyBody(),
    );
  }
}
